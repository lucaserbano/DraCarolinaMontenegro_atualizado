...
import heroImg from '../assets/foto para hero2.jpeg';
import secondSectionImg from '../assets/WhatsApp Image 2026-03-03 at 14.10.59.jpeg';

export default function Home() {
  return (
    <div className="bg-offwhite">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center overflow-hidden py-32 lg:py-40">
        {/* Background Elements */}
            ...
            <div className="max-w-2xl">
              ...
              >
                ...
                <h1 className="text-5xl sm:text-6xl md:text-7xl font-serif font-medium text-bordo leading-[1.1] mb-8">
                  Cuidado que pulsa <br/>
                  <span className="italic text-grafite">com a vida.</span>
                </h1>
                <p className="text-lg text-grafite/70 mb-12 leading-relaxed max-w-lg font-light">
                  Atendimento médico de excelência em Insuficiência Cardíaca e Transplante Cardíaco. Uma abordagem humana e especializada para a saúde do seu coração.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
             <div className="order-2 md:order-1 relative">
                <div className="aspect-[4/3] bg-pearl/30 rounded-lg overflow-hidden shadow-lg">
                   {/* Placeholder for medical context image */}
                   <img 
                    src={secondSectionImg}
                    alt="Cuidado Cardiológico" 
             ...
             <div className="order-1 md:order-2">
                <h2 className="text-3xl md:text-4xl font-serif text-bordo mb-8">Dra. Carolina Montenegro</h2>
                <p className="text-grafite/80 leading-relaxed mb-8 font-light text-lg">
                  Graduada pela PUCPR e com residência em Clínica Médica e Cardiologia, especializei-me em Insuficiência Cardíaca Avançada e Transplante Cardíaco no InCor-HCFMUSP, referência na América Latina.
                </p>
                <p className="text-grafite/80 leading-relaxed mb-10 font-light text-lg">
                  Minha trajetória inclui experiência internacional no Baylor Scott & White Health (Dallas, EUA), trazendo o que há de mais atual para o tratamento dos meus pacientes.
                </p>
      ...
      <section className="py-40 bg-offwhite relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-24">
            ...
            <p className="text-grafite/70 font-light text-lg">
              Foco especializado no diagnóstico, tratamento e acompanhamento de condições cardíacas complexas.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Acompanhamento especializado para pacientes com coração fraco, visando qualidade de vida e estabilidade clínica.'
              },
              {
      ...
      <section className="py-40 bg-bordo text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-20">
             ...
             <div className="bg-white/5 p-8 rounded-lg border border-white/10 hover:bg-white/10 transition-colors">
                ...
                <div className="text-sm text-white/90 font-medium">
                   <p>Tel: (41) 3082-0069</p>
                   <p>WhatsApp: (41) 98421-6135</p>
                </div>
             </div>
